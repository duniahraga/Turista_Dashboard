...
const GuestsAddModel = forwardRef((props, ref) => {
	...
	async function addData(value) {
		...
		try {
			const response = await axios.post('http://localhost:8082/Guests', value, {
				headers: {
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<input
												...
												placeholder="Guests"
												onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.Guests}
											/>
											{formikObj.errors.Guests && formikObj.touched.Guests ? <div className=' alert alert-danger'>{formikObj.errors.Guests}</div> : ""}
