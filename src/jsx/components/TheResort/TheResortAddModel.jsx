...
const TheResortAddModel = forwardRef((props, ref) => {
	...
	async function addData(value) {
		...
		try {
			const response = await axios.post('http://localhost:8082/Restore', value, {
				headers: {
	...
	const handleSearchBoxLoad = (searchBox) => {
		console.log('SearchBox loaded:', searchBox);
	};
	...
	const formikObj = useFormik({
		...
		validate: function (value) {
			...
			if (value.Seizurelaw.length < 3 || value.Seizurelaw.length > 50) {
				errors.Seizurelaw = 'The Seizure law  must be not less than 3 letters long '
			}

			if (value.Abolitionlaw.length < 3 || value.Abolitionlaw.length > 66) {
				errors.Abolitionlaw = 'The Abolition law must be not less than 3 leters long  '
			}
							...
							<form onSubmit={formikObj.handleSubmit}>
								<div className="row">
									<div className='col-lg-12 mb-1'>
										...
										<LoadScript googleMapsApiKey="AIzaSyAItmPJt0PQy4507Pu5j1f4-VFe77RjqvU" libraries={["places"]}>
											<GoogleMap
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<Field name="Cities" className="default-select form-control" as="select">
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<Field name='Zones' className="default-select form-control" as="select"  >
												<option data-display="Select">Please select</option>
												<option value="html">Ind</option>
												<option value="css">USA</option>
												<option value="javascript">UK</option>
														...
														<div className="col-xl-4 col-xxl-4 col-4">
															<div className="form-check custom-checkbox mb-3">
																<input
																	...
																	id="customCheckBox1"
																	name="NearSea"
																	onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.NearSea}
														...
														<div className="col-xl-7 col-xxl-7 col-7">
															<div className="form-check custom-checkbox mb-3 ">
																...
																<input
																	...
																	onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.NumberOfMeter}
									...
									<div className="col-lg-6 mb-2 picker-data">
										...
										<div className="color-time-picker">
											<input className=' form-control' type="time" name='CheckInTime' onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.CheckInTime} required />
											{formikObj.errors.CheckInTime && formikObj.touched.CheckInTime ? <div className=' alert alert-danger'>{formikObj.errors.CheckInTime}</div> : ""}
									...
									<div className="col-lg-6 mb-3 picker-data">
										<div className="form-group mb-3">
											...
											<div className="color-time-picker">
												<input className=' form-control' type="time" name='CheckOutTime' onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.CheckOutTime} required />
												{formikObj.errors.CheckOutTime && formikObj.touched.CheckOutTime ? <div className=' alert alert-danger'>{formikObj.errors.CheckOutTime}</div> : ""}
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<input
												...
												onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.latitude}

											/>

											{formikObj.errors.latitude && formikObj.touched.latitude ? <div className=' alert alert-danger'>{formikObj.errors.latitude}</div> : ""}
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<input
												...
												onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.longitude}
											/>
											{formikObj.errors.longitude && formikObj.touched.longitude ? <div className=' alert alert-danger'>{formikObj.errors.longitude}</div> : ""}
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<input
												...
												onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.Seizurelaw}
											/>
											{formikObj.errors.Seizurelaw && formikObj.touched.Seizurelaw ? <div className=' alert alert-danger'>{formikObj.errors.Seizurelaw}</div> : ""}
									...
									<div className="col-lg-6 mb-2">
										<div className="form-group mb-3">
											...
											<input
												...
												onBlur={formikObj.handleBlur} onChange={formikObj.handleChange} value={formikObj.values.Abolitionlaw}
											/>
											{formikObj.errors.Abolitionlaw && formikObj.touched.Abolitionlaw ? <div className=' alert alert-danger'>{formikObj.errors.Abolitionlaw}</div> : ""}
